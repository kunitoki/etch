...
const keywords = [
  ...
  "comptime","compiles","defer","new","and","or","not","as","array","nil","option","match",
  "some","none","ok","error","type","distinct","object","enum","import","export","discard","tuple",
  "yield","resume","spawn","channel","typeof","typedesc"
].toSeq
