...
- **Arbitrary parameter counts**: No limit on the number of parameters (previously limited to 0-4)
- **Type-safe marshalling**: Automatic conversion between Etch and C types
- **Cross-platform**: Works on Linux, macOS, and Windows
- **Static linking**: libffi is statically linked for zero runtime dependencies
